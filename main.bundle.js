    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_5__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_8__angular_router__["a" /* RouterModule */].forRoot([
                ...
                { path: 'admin', component: __WEBPACK_IMPORTED_MODULE_13__admin_admin_component__["a" /* AdminComponent */], canActivate: [__WEBPACK_IMPORTED_MODULE_16__services_auth_guard_service__["a" /* AuthGuard */]] },
...
var AuthService = (function () {
    ...
    AuthService.prototype.isLoggedIn = function () {
        ...
        // let jwtHepler = new JwtHelper();
        // let token = localStorage.getItem('token');
        // if(!token)
        //   return false;
        // let isExpired = jwtHepler.isTokenExpired(token);
        // return !isExpired;
    };
...
var OrderService = (function () {
    ...
    OrderService.prototype.getOrders = function () {
        ...
        var opions = new __WEBPACK_IMPORTED_MODULE_0__angular_http__["ResponseOptions"]({ headers: headers });
        return this.http.get('/api/orders', opions)
